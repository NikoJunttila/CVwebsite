...
export const Plans : Workouts[] = [
    ...
    days:"3-6",id:2,plans:[
    {id:7,aproxTime:60,day:"Push = Chest/Shoulders/triceps",
    exercises:[{sets:4,reps:"8-10",setsDone:0,done:false,exercise:"Flat Barbell Bench Press"},{sets:3,reps:"12",setsDone:0,done:false,exercise:"Incline Bench Press"},{sets:3,reps:"12",setsDone:0,done:false,exercise:"Seated Shoulder Press"} ,{sets:3,reps:"10-12",setsDone:0,done:false,exercise:"Flat Bench Dumbell Flyes"},{sets:3,reps:"10-12",setsDone:0,done:false,exercise:"Standing Dumbell Lateral Raises"},{sets:3,reps:"12-15",setsDone:0,done:false,exercise:"Tricep Rope Pushdown"},{sets:3,reps:"12",setsDone:0,done:false,exercise:"EZ Bar Skullcrusher"}]},
    {id:8,aproxTime:60,day:"Pull = Back/biceps/",exercises:[{sets:3,reps:"8",setsDone:0,done:false,exercise:"Barbell Row"},{sets:3,reps:"8",setsDone:0,done:false,exercise:"Neutral Lat Pulldown"},{sets:2,reps:"12-15",setsDone:0,done:false,exercise:"Dumbbell Shrug"},
    {sets:2,reps:"12",setsDone:0,done:false,exercise:"Face Pull"},{sets:3,reps:"8-12",setsDone:0,done:false,exercise:"Barbell Curl"},{sets:3,reps:"12-15",setsDone:0,done:false,exercise:"Hammer Curl"},{sets:3,reps:"12-15",setsDone:0,done:false,exercise:"Leg Raises"}]},
    {id:9,aproxTime:60,day:"Legs",exercises:[{sets:3,reps:"8",setsDone:0,done:false,exercise:"Barbell Squat"},{sets:3,reps:"10-12",setsDone:0,done:false,exercise:"Romanian Deadlift"},{sets:3,reps:"8-10",setsDone:0,done:false,exercise:"Leg Press"}
    ,{sets:3,reps:"10-12",setsDone:0,done:false,exercise:"Barbell Lunges"},{sets:3,reps:"15-20",setsDone:0,done:false,exercise:"Leg Curl"},{sets:3,reps:"10-12",setsDone:0,done:false,exercise:"Calf press"}]},
]} ,
